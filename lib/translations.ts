...
export const translations: Record<"en" | "bn", TranslationMap> = {
  ...
  bn: {
    ...
    expertSolutions: {
      ...
      corporate: "কর্পোরেট ও গ্রুপ ভ্রমণ",
      corporate_body:
    ...
    tourShowcase: {
      ...
      explore_world_desc:
        "নির্জন সমুদ্রতট, মনোমুগ্ধকর দ্বীপ, সুউচ্চ পর্বতমালা থেকে শুরু করে শান্ত ও একান্ত অবকাশের গন্তব্য—প্রতিটি ভ্রমণস্থান আমরা যত্নসহকারে নির্বাচন করি, যাতে আপনার প্রতিটি সফর হয়ে ওঠে আরামদায়ক, স্মরণীয় ও অনন্য।",
      immersive_exp: "নিমজ্জিত করার মতো অভিজ্ঞতা",
      curated_discoveries: "যত্নে নির্বাচিত গন্তব্য",
      curated_discoveries_desc:
        "প্রচলিত ভ্রমণ গাইডের সীমা ছাড়িয়ে আমরা আপনাকে দিই এক ভিন্ন অভিজ্ঞতা। স্থানীয় সংস্কৃতির কাছাকাছি যাওয়ার সুযোগ, ব্যক্তিগত গাইডেড ট্যুর এবং বিশেষ ভিআইপি সেবার সমন্বয়ে প্রতিটি ভ্রমণ পরিকল্পনা তৈরি করা হয় আপনার রুচি ও পছন্দকে কেন্দ্র করে।",
    ...
    umrahPage: {
      ...
      description:
        "আমাদের সতর্কতার সাথে পরিকল্পিত ওমরাহ প্যাকেজগুলোর সাথে একটি গভীর আধ্যাত্মিক যাত্রায় যাত্রা শুরু করুন। আমরা নিশ্চিত করি যে আপনার মনোযোগ যেন সম্পূর্ণভাবে আপনার ইবাদত এবং শান্তিতে থাকে, আর আমরা বাকি সমস্ত আয়োজন, হারামের কাছাকাছি প্রিমিয়াম আবাসন এবং আরামদায়ক যাতায়াত ব্যবস্থা পরিচালনা করব।",
    },
    visaPage: {
    ...
    popularPackages: {
      "maldives-luxury": {
        title: "মালদ্বীপে বিলাসবহুল ভ্রমণ",
        location: "মালদ্বীপ",
        description:
      ...
      "dubai-city": {
        title: "দুবাই শহরের রোমাঞ্চকর ভ্রমণ",
      ...
      "short-umrah": {
        title: "স্বল্পমেয়াদি ওমরাহ প্যাকেজ",
        location: "সৌদি আরব",
        description:
      ...
      "swiss-alps": {
        title: "সুইস আল্পসে রোমাঞ্চকর অভিযান",
    ...
    globe: {
      global_destinations: "বিশ্বজুড়ে আকর্ষণীয় গন্তব্য",
      unrestricted_routing: "সীমাহীন ভ্রমণের স্বাধীনতা",
      unrestricted_routing_desc:
