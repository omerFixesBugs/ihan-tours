...
// import {mecca} from "@/public/umrah/mecca.jpg"

export default function UmrahPageClient() {
  const { t } = useLanguage();
  ...
  return (
    <main className="min-h-screen bg-background text-foreground flex flex-col">
      <PageHeader 
        title={t("umrahPage.title")} 
        subtitle={t("umrahPage.subtitle")} 
        video="/umrah/kaba.mp4" 
      />
